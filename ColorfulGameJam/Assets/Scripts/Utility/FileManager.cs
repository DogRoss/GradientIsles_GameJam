 ...
 * 
 * FileManager is the save data class for the Unity Project.
 * To save an object to a file, provide a file name/file path and the object to save.
 * To read an object and load it, provide a file name/file path and the object's type.
 * 
 * The files are saved in the .iink format. Invisible Ink is my own save file format 
 * which makes files appear completely invisible in programs like Notepad++.
 */

//! FileManager is the save data class. Supports saving and reading from .iink files.
/// <summary>
/// Author: Justin Scruggs
/// <remarks>
/// <para>
...
{
    //! Save a class object to a file in the persistent data path. Returns true if the save was successful.
    /// <summary>
    ...
    //! Save a class object to a file. Returns true if the save was successful. The file is encoded in "InvisibleInk" on top of .json.
    /// <summary>
    ...
    //! Read a class object from a file in the persistent data path.
    /// <summary>
    ...
    //! Read a class object from a file in the persistent data path, given a type parameter.
    /// <summary>
    ...
    //! Read a class object from a file. The file is encoded in "InvisibleInk" on top of .json.
    /// <summary>
    ...
    //! Read a class object from a file, given a type parameter.
    /// <summary>
